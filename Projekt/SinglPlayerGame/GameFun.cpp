...
void GameRun(Engine *super) {
    ...
    if (super->game.getPasue()) {
        ...
        if (super->game.pauseMenu.GetSaveAndExit()->onClicked(super->getFrame(), super->getEvent())) {
            super->game.saveToFile(
                    Point2D(super->game.getPlayer1()->getTank()->getPosX(),
                            super->game.getPlayer1()->getTank()->getPosY()),
                    Point2D(super->game.getPlayer2()->getTank()->getPosX(),
                            super->game.getPlayer2()->getTank()->getPosY()),
    ...
    } else if ((super->game.getPlayer1()->getPoints() == 0) || (super->game.getPlayer2()->getPoints() == 0)) {
        ...
        super->game.getPlayer1()->getTank()->drawMissile(super->getFrame(), super->getClock(),
                                                         super->game.getPlayer1()->getMissileCords());
        ...
        super->game.getPlayer2()->getTank()->drawMissile(super->getFrame(), super->getClock(),
                                                         super->game.getPlayer2()->getMissileCords());
